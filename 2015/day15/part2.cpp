...
long long Day15Part2::getScore(vector<int> dist) {
    long long cScore = 0;
    long long tScore = 0;
    long long fScore = 0;
    long long dScore = 0;
 ...
 */
long long Day15Part2::findBestScoreRecursive(vector<int> dist, int idx, int tspAvailable, long long bestScore) {
    if (idx == dist.size()-1) {
...
void Day15Part2::run(std::string inputFile) {
