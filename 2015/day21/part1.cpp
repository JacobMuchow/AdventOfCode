...
void Day21Part1::loadShop(std::string inputFile) {
...
bool Day21Part1::simulate(std::shared_ptr<Loadout> myLoadout, int myHp, std::shared_ptr<Loadout> bossLoadout, int bossHp) {
...
void Day21Part1::run(std::string inputFile) {
