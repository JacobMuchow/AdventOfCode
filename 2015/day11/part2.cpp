...
void Day11Part2::run(std::string inputFile) {
    ...
    cout << "next pass 2: " << next << endl;
}

string Day11Part2::nextPassword(string password) {
...
std::string Day11Part2::incrementAt(std::string pass, int pos) {
    if (pass[pos] == 'z') {
...
int Day11Part2::passwordValid(std::string str) {
...
bool Day11Part2::invalidChar(char val) {
